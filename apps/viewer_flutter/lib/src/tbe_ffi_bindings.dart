...
typedef _CreateWallTypeNative = ffi.Int32 Function(
  ffi.Pointer<ffi.Void>,
  ffi.Int32,
  ffi.Pointer<Utf8>,
  ffi.Pointer<ffi.Uint64>,
...
typedef _CreateWallTypeDart = int Function(
  ffi.Pointer<ffi.Void>,
  int,
  ffi.Pointer<Utf8>,
  ffi.Pointer<ffi.Uint64>,
...
typedef _UpsertWallTypeForWallNative = ffi.Int32 Function(
  ffi.Pointer<ffi.Void>,
  ffi.Uint64,
  ffi.Int32,
  ffi.Pointer<Utf8>,
...
typedef _UpsertWallTypeForWallDart = int Function(
  ffi.Pointer<ffi.Void>,
  int,
  int,
  ffi.Pointer<Utf8>,
