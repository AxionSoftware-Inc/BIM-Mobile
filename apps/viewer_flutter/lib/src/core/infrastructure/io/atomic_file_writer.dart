...
/// Replaces a small checkpoint without exposing a partially-written target
/// file to the next application start.
///
/// INFRASTRUCTURE: this is the canonical local-filesystem write primitive.
/// Domain/application modules should depend on a higher-level repository/port
/// rather than calling it directly when persistence semantics matter.
