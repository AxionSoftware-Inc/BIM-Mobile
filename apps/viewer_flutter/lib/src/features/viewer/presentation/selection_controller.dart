...
///
/// VIEWER PRESENTATION OWNERSHIP: this controller mirrors viewport interaction
/// state and deliberately does not become persisted project semantics.
/// Rendering backends only mirror this state. No Inspector widget keeps its
/// own selected object, preventing 2D/3D/elevation selection drift.
