...
import '../../../annotations/application/annotation_workspace_runtime.dart';
import '../../../../core/presentation/design_system/arvela_brand.dart';
import '../viewport/render_scene_viewport_planar.dart';
import '../viewport/render_scene_viewport_types.dart';

export '../../../annotations/domain/annotation_view_key.dart';
export '../../../annotations/presentation/annotation_viewport_overlay.dart';
export '../../../annotations/application/annotation_workspace_runtime.dart';
...
class _AuthoringToolPaletteState extends State<AuthoringToolPalette> {
  ...
  AnnotationWorkspaceTool _annotationTool = WorkspaceToolSelection.annotationTool;
                  ...
                  children: <Widget>[
                    ...
                    if (_tab == WorkspaceToolTab.model) ...<Widget>[
                      ...
                      PopupMenuButton<RenderSceneInteractionMode>(
                        ...
                        itemBuilder: (context) => <PopupMenuEntry<RenderSceneInteractionMode>>[
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            PopupMenuButton<RenderSceneDisplayStyle>(
              ...
              itemBuilder: (context) => <PopupMenuEntry<RenderSceneDisplayStyle>>[
            ...
            if (is3D)
              _DeckIconButton(
                tooltip: hdriVisible ? 'Hide HDRI background' : 'Show HDRI background',
            ...
            if (is3D)
              _DeckIconButton(
                tooltip: orbitStyle == RenderSceneOrbitProjectionStyle.perspective
                    ? 'Perspective projection'
                    : 'Orthographic projection',
                selected: orbitStyle == RenderSceneOrbitProjectionStyle.orthographic,
                enabled: hasScene,
            ...
            if (is3D)
              _DeckIconButton(
                tooltip: hasSectionBox ? '3D Section Box active' : '3D Section Box',
...
const List<_AuthoringTool> _primaryTools = <_AuthoringTool>[
  _AuthoringTool(RenderSceneInteractionMode.select, Icons.ads_click_outlined, 'Select'),
  _AuthoringTool(RenderSceneInteractionMode.addWall, Icons.architecture_outlined, 'Wall'),
  _AuthoringTool(RenderSceneInteractionMode.addDoor, Icons.door_front_door_outlined, 'Door'),
  _AuthoringTool(RenderSceneInteractionMode.addWindow, Icons.window_outlined, 'Window'),
  _AuthoringTool(RenderSceneInteractionMode.addRoom, Icons.meeting_room_outlined, 'Room'),
  _AuthoringTool(RenderSceneInteractionMode.addFloor, Icons.layers_outlined, 'Floor'),
  _AuthoringTool(RenderSceneInteractionMode.addCeiling, Icons.space_dashboard_outlined, 'Ceiling'),
  _AuthoringTool(RenderSceneInteractionMode.addRoof, Icons.roofing_outlined, 'Roof'),
  _AuthoringTool(RenderSceneInteractionMode.addStair, Icons.stairs_outlined, 'Stair'),
];

const List<_AuthoringTool> _secondaryTools = <_AuthoringTool>[
  _AuthoringTool(RenderSceneInteractionMode.addLevel, Icons.add_chart_outlined, 'Add level'),
  _AuthoringTool(RenderSceneInteractionMode.moveLevel, Icons.height_outlined, 'Move level'),
  _AuthoringTool(RenderSceneInteractionMode.moveWall, Icons.open_with_outlined, 'Move wall'),
  _AuthoringTool(RenderSceneInteractionMode.moveOpening, Icons.compare_arrows_outlined, 'Move opening'),
  _AuthoringTool(RenderSceneInteractionMode.trimExtend, Icons.call_merge_outlined, 'Trim / Extend'),
];

const List<_AnnotationTool> _annotationTools = <_AnnotationTool>[
  _AnnotationTool(AnnotationWorkspaceTool.select, Icons.ads_click_outlined, 'Select', 'Select and edit a persistent annotation in this view'),
  _AnnotationTool(AnnotationWorkspaceTool.text, Icons.text_fields, 'Text', 'Place a view-scoped text note'),
  _AnnotationTool(AnnotationWorkspaceTool.dimension, Icons.straighten_outlined, 'Dim', 'Create a persistent linear/aligned dimension'),
  _AnnotationTool(AnnotationWorkspaceTool.tag, Icons.sell_outlined, 'Tag', 'Tag a BIM element without copying its data'),
  _AnnotationTool(AnnotationWorkspaceTool.detailLine, Icons.timeline_outlined, 'Detail', 'Draw view-only detail linework'),
  _AnnotationTool(AnnotationWorkspaceTool.symbol, Icons.category_outlined, 'Symbol', 'Place a shared annotation/detail symbol'),
];
