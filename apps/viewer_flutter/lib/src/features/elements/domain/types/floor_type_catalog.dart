...
enum FloorSurfaceKind { asphalt, concrete, wood, generic, grass, paving }

extension FloorSurfaceKindLabel on FloorSurfaceKind {
  String get key => switch (this) {
        FloorSurfaceKind.asphalt => 'asphalt',
        FloorSurfaceKind.concrete => 'concrete',
        FloorSurfaceKind.wood => 'wood',
        FloorSurfaceKind.generic => 'generic',
        FloorSurfaceKind.grass => 'grass',
        FloorSurfaceKind.paving => 'paving',
      };
...
final class FloorTypeDefinition {
  ...
  static FloorTypeDefinition? fromJson(Object? value) {
    ...
    final surfaceKind = _floorSurfaceKind(
      value['surface_key'] ?? value['surfaceKey'] ?? value['floor_type'] ?? name,
    );
