...
/// Typed compatibility read-model for stair instances.
///
/// MIGRATION: path points still use RenderScenePoint because this is an
/// application adapter over the compatibility scene. A future authoritative
/// stair path contract should replace this adapter rather than leak RenderScene
/// types into the element domain.
