...
/// Typed authored wall values projected from the RenderScene compatibility
/// read-model.
///
/// APPLICATION OWNERSHIP: this is not the authoritative wall domain object.
/// It is a typed adapter for legacy/compatibility scene metadata used by
/// Inspector and authoring presentation code during the 0.3.2 migration.
