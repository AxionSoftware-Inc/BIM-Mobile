...
/// Tablet authoring dialog for adding a nested-family dependency from an
/// explicit set of available assets.
///
/// Storage discovery is intentionally outside presentation. The parent stores
/// stable family/type ids only; dependency resolution happens at application
/// boundaries during preview/save/placement.
abstract final class FamilyNestedFeatureDialog {
  static Future<FamilyFeature?> show(
    BuildContext context, {
    required FamilyDocument parent,
    required Iterable<FamilyAssetFile> availableAssets,
  }) async {
