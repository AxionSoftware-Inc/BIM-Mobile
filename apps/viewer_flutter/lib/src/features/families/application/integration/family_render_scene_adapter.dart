...
/// Converts the independent Family geometry contract into the RenderScene
/// compatibility contract consumed by the project viewport.
///
/// Family coordinates are X = width, Y = height, Z = depth. RenderScene uses
/// X/Y for the plan plane and Z for elevation, therefore the coordinate
/// conversion is (x, z, y). Camera, gesture and renderer concerns stay outside
/// this adapter.
        ...
        RenderSceneObject(
          ...
          metadata: <String, Object?>{
            ...
            if (finalFeature != null)
              'family_feature_kind': finalFeature.kind.name,
