...
/// Builds project-viewport scenes for Family Authoring from explicit inputs.
///
/// Nested-family resolution is pure: callers provide the documents available
/// to the operation. Library/cloud storage is handled by infrastructure
/// adapters outside this service.
abstract final class FamilyAuthoringSceneBuilder {
  ...
  static RenderScene buildCandidates(
    ...
    for (var index = 0; index < document.features.length; index++) {
      ...
      if (truncated.features.any(
        ...
        evaluatedDocument = FamilyDependencyResolver.resolve(
          truncated,
          type,
